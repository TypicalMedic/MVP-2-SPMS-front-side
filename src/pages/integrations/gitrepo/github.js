...
const googleCalendarAuth = `${process.env.REACT_APP_SERVER_ADDR}/api/v1/auth/integration/authlink/github`;
...
function GitHub() {
    ...
    {/* дополнительное окно вполне может пригодиться, в частности для выбора корневой папки (правда как это сделать?) ну и мб для другой информации? */}
        <Button as="a" onClick={OpenAuth} className='style-button mb-3'>Авторизоваться в GitHub(testing)</Button>
    </>
};
